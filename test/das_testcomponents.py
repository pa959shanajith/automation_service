#-------------------------------------------------------------------------------
# Name:        das_testcomponents.py
# Purpose:     this file includes test componenets of das
#              for testing the das components without flask features can be
#              performed here
#
# Author:      vishvas.a
#
...
dbhistorysesssion = cluster.connect()
...
##
##dbhistorysesssion.row_factory = dict_factory
##dbhistorysesssion.set_keyspace('nineteen68history')
...
def authenticateUser_ldap(data):
##    requestdata=json.loads(request.data)
    requestdata=data
...
####@app.route('/design/authenticateUser/ldap',methods=['POST'])
##def authenticateUser_ci(data):
####    requestdata=json.loads(request.data)
##    requestdata=data
##    authenticateuser = "select password from users where username = '"+requestdata["username"]+"' allow filtering;"
##    queryresult = dbsession.execute(authenticateuser)
...
def authenticateUser_projassigned(data):
    try:
##        requestdata=json.loads(request.data)
        requestdata=data
...
#fetch user data into Avo Assure
...
def updateUser(data):
    ...
    ##    requestdata=json.loads(request.data)
        ...
        if(requestdata['query'] == 'userdetails'):
            ...
            queryresult = dbsession.execute(updateuserquery1)
            res={'rows':queryresult.current_rows}
...
##    print response
#   ----------------------------
#  authenticateUser_ldap
##    data = {
##			"username": "<username>"
##		  }
##    response = authenticateUser_ldap(data)
##    print response
#   ----------------------------
#  authenticateUser_projassigned
##    data = {
##			"username": "<username>",
##            "query":"getUsers"
##            "query":"getUserRole",
...
##            "userid" :"<userid>"
##		  }
##    response = authenticateUser_projassigned(data)
##    print response
#   ----------------------------
#  loadUserInfo
##    data = {
...
##            "roleid" :"<roleid>"
##		  }
##    response = getRoleNameByRoleId(data)
##    print response
#   ----------------------------
#  getAllSuites_ICE
##    data = {
